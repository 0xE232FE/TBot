    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                var proxy = settings.General.Proxy ?? "";
                var proxyType = settings.General.ProxyType ?? "";
                ogamedService = new OgamedService(credentials, (string)host, int.Parse(port), (string)proxy, (string)proxyType);
            }
            catch (Exception e)
            {
